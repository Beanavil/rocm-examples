...
- [Applications](./Applications/README.md) groups a number of examples ... .
    - [floyd_warshall](./Applications/floyd_warshall/README.md): Showcases a GPU implementation of the Floyd-Warshall algorithm for finding shortest paths in certain types of graphs.
